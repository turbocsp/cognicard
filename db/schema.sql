...
\restrict uf9YuE0AcGjzG76weHWfVsiKqQOGEFsc3BZ64taawpCR3cvGIVYzA3uVC8Xa9le
...
--
-- Name: get_card_statistics(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_card_statistics(p_deck_id uuid, p_user_id uuid) RETURNS TABLE(card_id uuid, total_views bigint, correct_count bigint, accuracy numeric)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_daily_summary(uuid, date); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_daily_summary(p_user_id uuid, p_date date) RETURNS TABLE(deck_name text, attempt_number integer, correct_count bigint, incorrect_count bigint)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_deck_statistics(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_deck_statistics(p_deck_id uuid, p_user_id uuid) RETURNS TABLE(attempt_number integer, correct_count integer, incorrect_count integer, total_cards integer, completed_at timestamp with time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: get_last_attempt(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_last_attempt(deck_id_param uuid) RETURNS TABLE(id uuid, user_id uuid, deck_id uuid, attempt_number integer, correct_count integer, incorrect_count integer, last_studied_card_id uuid, created_at timestamp with time zone, completed_at timestamp with time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
    ...
    WHERE a.deck_id = deck_id_param AND a.user_id = auth.uid()
...
--
-- Name: get_study_activity(uuid, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_study_activity(p_user_id uuid, p_year integer) RETURNS TABLE(study_date date, count integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: get_study_streak(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_study_streak(p_user_id uuid) RETURNS TABLE(current_streak integer, longest_streak integer)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: search_cards(text, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.search_cards(search_term text, p_user_id uuid) RETURNS TABLE(id uuid, front_content text, back_content text, tags text[], deck_id uuid, deck_name text)
    LANGUAGE plpgsql
    AS $$
BEGIN
  -- Inicia a consulta
...
--
-- Name: study_log; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: study_log study_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: attempts attempts_deck_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attempts
    ADD CONSTRAINT attempts_deck_id_fkey FOREIGN KEY (deck_id) REFERENCES public.decks(id) ON DELETE CASCADE;


--
-- Name: attempts attempts_last_studied_card_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attempts
    ADD CONSTRAINT attempts_last_studied_card_id_fkey FOREIGN KEY (last_studied_card_id) REFERENCES public.cards(id) ON DELETE SET NULL;
...
--
-- Name: decks decks_folder_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.decks
    ADD CONSTRAINT decks_folder_id_fkey FOREIGN KEY (folder_id) REFERENCES public.folders(id) ON DELETE CASCADE;
...
--
-- Name: study_log study_log_attempt_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.study_log
    ADD CONSTRAINT study_log_attempt_id_fkey FOREIGN KEY (attempt_id) REFERENCES public.attempts(id) ON DELETE CASCADE;


--
-- Name: study_log study_log_card_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.study_log
    ADD CONSTRAINT study_log_card_id_fkey FOREIGN KEY (card_id) REFERENCES public.cards(id) ON DELETE CASCADE;


--
-- Name: study_log study_log_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: study_log Allow individual user access to their own study logs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow individual user access to their own study logs" ON public.study_log USING ((auth.uid() = user_id));


--
-- Name: attempts Users can manage their own attempts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can manage their own attempts" ON public.attempts USING ((auth.uid() = user_id));
...
CREATE POLICY "Users can manage their own cards" ON public.cards USING ((auth.uid() = user_id));


--
-- Name: decks Users can manage their own decks; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can manage their own decks" ON public.decks USING ((auth.uid() = user_id));
...
--
-- Name: study_log; Type: ROW SECURITY; Schema: public; Owner: -
--
...
\unrestrict uf9YuE0AcGjzG76weHWfVsiKqQOGEFsc3BZ64taawpCR3cvGIVYzA3uVC8Xa9le
